...
func main() {
	...
	query1 = strings.TrimSpace(query1)

	firstNameMatches := searchCsv("FirstName", query1);
	lastNameMatches :=  searchCsv("LastName", query1);

	fullMatches := append(firstNameMatches, lastNameMatches...)


	for _,rowId := range fullMatches {
