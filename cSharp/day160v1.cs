...
void cutRow(string[] row)
{
    clipboardRow = row;
}

int pasteRow(string[] columns, int? deleteRowWhenPasted, int selectedRowId, int selectedRowIndex)
{
    ...
    newAllRows[selectedRowId] = new string[]{"x","",""};
...
while (true)
{
    ...
    else if (rowSelectionMode)
    {
        ...
        {
            cutRow(allRows[selectedRowIndex]);
            ...
            selectedRowIndex = targetRowId;
            selectedRowId = selectedRowIndex == 0 ? 0 :int.Parse(rows[selectedRowIndex][0]);

            pasteRow(columns, deleteRowWhenPasted, selectedRowId, selectedRowIndex);
            continue;
        }
        ...
        )
        {
            ...
            selectedRowIndex = pasteRow(columns, deleteRowWhenPasted, selectedRowId, selectedRowIndex);
