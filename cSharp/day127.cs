...
void RenameColumnRoutine()
{
    Console.WriteLine("Input the column you want to rename");

    string oldColumnNameInput = Console.ReadLine();

    if (oldColumnNameInput == "")
    {
        return;
    }

    Console.WriteLine("Input the new name of the column");
    ...
    renameColumn(oldColumnNameInput, newColumnNameInput);
}
