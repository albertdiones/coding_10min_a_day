...
int? rowId = FindFirstCsvRow("Name", query1);

if (rowId != null)
{
    string[] row = ReadCsvRow(rowId.Value);
    Console.WriteLine("Person is found, email: " + row[0]);
}
else
{
    Console.WriteLine("Person was not found in the db");
}