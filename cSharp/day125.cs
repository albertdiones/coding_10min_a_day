...
while (true)
{
    ...
    Console.WriteLine("  [A] Add new row");
    Console.WriteLine("  [U] Update selected row");
    Console.WriteLine("  [C] Add new column");
    Console.WriteLine("  [Del] Delete selected row");
    Console.WriteLine("  [D] Delete column");
