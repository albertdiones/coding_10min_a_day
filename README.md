...
64. Ask for a password input and save to a txt file
65. Ask for a password input and save to a txt file as hash
66. Check if string contains a digit w/o using regex
67. Check if string contains lowercase letter w/o using regex
68. Check if string contains uppercase letter w/o using regex
69. Check if string contains a symbol w/o using regex
